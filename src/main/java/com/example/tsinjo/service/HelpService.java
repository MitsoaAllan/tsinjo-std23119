...
public class HelpService {
  ...
  public Help createHelp(
      String beneficiaryEmail, String fullName, Payment payment, String accidentDescription) {
    Beneficiary beneficiary =
        beneficiaryRepository
            .findByEmail(beneficiaryEmail)
            .orElseGet(
                () -> {
    ...
    Help help = new Help(beneficiary.getId(), payment, accidentDescription);
